/**
 * @file DispTest.cpp
 * @brief Display initialization, test patterns, and brightness control
 */
#include "../FactoryTest.h"
#include "DispLGFXCfg.hpp"
...
void FactoryTest::_disp_test()
{
    ...
    else
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            switch (i)
            {
            case 0: color_r = 0;   color_g = 0;   color_b = 0;   break;
            case 1: color_r = 255; color_g = 0;   color_b = 0;   break;
            case 2: color_r = 0;   color_g = 255; color_b = 0;   break;
            case 3: color_r = 0;   color_g = 0;   color_b = 255; break;
            }
            for (int n = 0; n < 240; n++)
            {
        ...
        for (int i = 0; i < 4; i++)
        {
            switch (i)
            {
            case 0: color_r = 255; color_g = 255; color_b = 255; break;
            case 1: color_r = 255; color_g = 0;   color_b = 0;   break;
            case 2: color_r = 0;   color_g = 255; color_b = 0;   break;
            case 3: color_r = 0;   color_g = 0;   color_b = 255; break;
            }
